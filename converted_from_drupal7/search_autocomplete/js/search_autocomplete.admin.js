...
(function ($) {
  ...
  Backdrop.behaviors.search_autocomplete_admin = {
    ...
    attach: function(context) {
      ...
      $("body").once('search-autocomplete', function () {
        $("<ul id='sa_admin_menu'><div class='sa_title'>Search Aucomplete</div><li class='sa_add'>" + Backdrop.t('add autocompletion') + "</li></ul>").appendTo($('body'));
      });
